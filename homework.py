...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        spent_calories: float = ((coeff_calorie_1 * midl_speed - coeff_calorie_2) * self.weight / self.M_IN_KM) * (self.duration * 60)
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        spent_calories: float = (coeff_calorie_1 * self.weight + (mean_speed**2 // self.height) * coeff_calorie_2 * self.weight) * (self.duration * 60)
        return spent_calories
...
class Swimming(Training):
    ...
    def get_mean_speed(self) -> float: #дописать докстирнг
